export type EnigmaErrorCode =
  ...
  | 'E_LOCK_TIMEOUT'
  /** The first-party flock addon has no packaged artifact for this platform/arch, or the artifact failed to load (Issue #66 mechanism decision). Fail-closed: there is no pure-JS fallback lock protocol. */
  | 'E_LOCK_UNAVAILABLE';
